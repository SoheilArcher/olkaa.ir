...
LANGUAGES = {
    "fa": {
        ...
        "lead": "یک هسته مشترک برای مدیریت مشتریان، امور مالی، خدمات دیتاسنتر، سامانه های هوانوردی، کال سنتر هوشمند و سرویس اختصاصی Home Check-in و CIP Express.",
        "nav": ["راهکارها", "CIP Express", "دیتاسنتر", "مشتریان", "دفاتر", "تماس"],
        "about_label": "درباره الکا",
        "login_label": "ورود کارمندان",
        ...
        "solutions_text": "محصولات و خدمات فاوا ایمن الکا برای کسب و کارهایی طراحی شده که به اتصال دقیق میان مشتری، عملیات، پشتیبانی، مالی و شبکه نیاز دارند.",
    ...
    "en": {
        ...
        "description": "Fava Emen Olka provides software platforms, aviation systems, datacenter services, dedicated internet, IPv4 leasing, AI Call Center, Home Check-in and CIP Express services.",
        ...
        "lead": "A shared operating core for customer management, finance, datacenter services, aviation systems, AI Call Center, Home Check-in and CIP Express.",
        ...
        "solutions_text": "Fava Emen Olka products are designed for teams that need a precise connection between customers, operations, support, finance and network services.",
        "signature_title": "Home Check-in & CIP Express",
    ...
    "ar": {
        ...
        "description": "تقدم فاوا إمن أولكا منصات برمجية، أنظمة طيران، خدمات مراكز البيانات، إنترنت مخصص، تأجير IPv4، مركز اتصال ذكي وخدمات Home Check-in وCIP Express.",
        ...
        "lead": "نواة تشغيلية مشتركة لإدارة العملاء، المالية، خدمات مراكز البيانات، أنظمة الطيران، مركز الاتصال الذكي، Home Check-in وCIP Express.",
        "nav": ["الحلول", "CIP Express", "مركز البيانات", "العملاء", "المكاتب", "اتصل بنا"],
        "about_label": "عن الشركة",
        "login_label": "دخول الموظفين",
        ...
        "solutions_text": "صممت منتجات وخدمات فاوا إمن أولكا للمؤسسات التي تحتاج إلى ربط دقيق بين العملاء والعمليات والدعم والمالية والشبكات.",
        "signature_title": "Home Check-in & CIP Express",
...
SERVICE_PAGES = {
    ...
    "ai-call-center": {
        "title": "کال سنتر هوشمند | AI Call Center فاوا ایمن الکا",
        "description": "معرفی کال سنتر هوشمند فاوا ایمن الکا برای خلاصه مکالمات، ارجاع درخواست، اتصال به دانش سازمانی، پشتیبانی چندزبانه و تحویل انسانی در فرایندهای حساس.",
        "eyebrow": "AI Call Center",
        "headline": "کال سنتر هوشمند برای پشتیبانی سریع، قابل پیگیری و انسانی",
        "lead": "AI Call Center فاوا ایمن الکا به عنوان مسیر برنامه ریزی شده برای کمک به تیم های پشتیبانی، فروش و خدمات طراحی می شود؛ با تمرکز بر خلاصه سازی مکالمه، دسته بندی درخواست، بازیابی دانش تایید شده و ارجاع انسانی در تصمیم های حساس.",
        "status": "Planned",
        "keywords": ["کال سنتر هوشمند", "AI Call Center", "مرکز تماس", "پشتیبانی مشتری", "خلاصه مکالمه", "ارجاع تیکت"],
        "audience": ["تیم های پشتیبانی", "مرکز تماس سازمانی", "خدمات فرودگاهی و هتلداری", "واحد فروش و ارتباط با مشتری"],
        "features": [
            "ثبت و خلاصه سازی مکالمات با نظارت انسانی",
            "دسته بندی درخواست و پیشنهاد مسیر ارجاع",
            "بازیابی پاسخ از دانش سازمانی تایید شده",
            "اتصال آینده به CRM، تیکتینگ و گزارش کیفیت پاسخگویی",
        ],
        "related": ["aviation-software", "cip-express", "datacenter"],
    },
}
...
COMMON = {
    ...
    "solutions": [
        ...
        ("CALL CENTER", {"fa": "کال سنتر هوشمند", "en": "AI Call Center", "ar": "مركز اتصال ذكي"}, "ai-call-center"),
    ...
    "solution_text": {
        "fa": "طراحی، استقرار و پشتیبانی راهکارهای عملیاتی و ارتباط با مشتری برای سازمان های حساس به کیفیت سرویس.",
        "en": "Design, deployment and support for operational and customer-service platforms where service quality matters.",
        "ar": "تصميم وتنفيذ ودعم حلول تشغيلية وخدمة عملاء للمؤسسات التي تعتمد على جودة الخدمة.",
    },
    "steps": {
